...
def main(args):
    ...
    causal = CausalPlanner(layers=args.graph_layers, modes=args.modes, nbr_enrich=args.nbr_enrich,
                           conflict_feats=args.conflict_feats, conflict_bias=args.conflict_bias).to(dev)
...
if __name__ == "__main__":
    ...
    p.add_argument("--conflict_feats", type=int, default=0)
    p.add_argument("--conflict_bias", type=int, default=0)
